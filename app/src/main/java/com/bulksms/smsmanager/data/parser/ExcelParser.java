...
public class ExcelParser {
    ...
    public static ParseResult parseWithSmartMapping(List<Map<String, String>> data) {
        if (data.isEmpty()) {
            return new ParseResult(new ArrayList<>(), new ColumnMapping());
        }
        ...
        return new ParseResult(recipients, mapping);
    }
    ...
    public static class ParseResult {
        ...
        public ParseResult(List<Recipient> recipients, ColumnMapping mapping) {
