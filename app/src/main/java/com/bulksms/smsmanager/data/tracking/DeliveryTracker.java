package com.bulksms.smsmanager.data.tracking;
...
public class DeliveryTracker {
    ...
    private void registerReceivers() {
        try {
            ...
            IntentFilter sentFilter = new IntentFilter("com.bulksms.smsmanager.SMS_SENT");
            context.registerReceiver(sentReceiver, sentFilter, Context.RECEIVER_EXPORTED);
            
            // Register delivered receiver  
            IntentFilter deliveredFilter = new IntentFilter("com.bulksms.smsmanager.SMS_DELIVERED");
    ...
    public DeliveryIntents createDeliveryIntents(String messageId) {
        try {
            ...
            Intent sentIntent = new Intent("com.bulksms.smsmanager.SMS_SENT");
            sentIntent.putExtra("messageId", messageId);
            
            Intent deliveredIntent = new Intent("com.bulksms.smsmanager.SMS_DELIVERED");
