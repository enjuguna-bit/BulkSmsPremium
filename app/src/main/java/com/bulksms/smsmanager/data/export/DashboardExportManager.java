package com.bulksms.smsmanager.data.export;
    ...
    public Completable exportKpiData() {
        return Completable.fromAction(() -> {
            try {
                ...
                // Get KPI data
                LiveData<List<com.bulksms.smsmanager.data.entity.KpiEntity>> kpisLive = kpiDashboardManager.getActiveAlerts();
                List<com.bulksms.smsmanager.data.entity.KpiEntity> kpis = kpisLive.getValue();
                if (kpis == null) {
                    kpis = new ArrayList<>();
                }
                ...
                try (FileWriter writer = new FileWriter(csvFile)) {
                    ...
                    for (com.bulksms.smsmanager.data.entity.KpiEntity kpi : kpis) {
