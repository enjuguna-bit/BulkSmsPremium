...
public class BiometricSettingsActivity extends AppCompatActivity {
    ...
    private void enableBiometric() {
        executor.execute(() -> {
            try {
                biometricManager.enableBiometric(this, new com.bulksms.smsmanager.auth.BiometricAuthCallback() {
                    @Override
    ...
    private void testBiometricAuth() {
        executor.execute(() -> {
            try {
                biometricManager.authenticate(this, new com.bulksms.smsmanager.auth.BiometricAuthCallback() {
                    @Override
                    public void onSuccess() {
                        runOnUiThread(() -> 
