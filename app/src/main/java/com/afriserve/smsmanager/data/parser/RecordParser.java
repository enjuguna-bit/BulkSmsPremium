...
public class RecordParser {
     ...
     */
    public static com.afriserve.smsmanager.models.Recipient customerToRecipient(CustomerRecord customer) {
        if (customer == null) {
            return null;
        }
        ...
        return new com.afriserve.smsmanager.models.Recipient(
            customer.name,
            customer.phone,
            customer.amount,
            false,
     ...
     */
    public static com.afriserve.smsmanager.models.Recipient loanToRecipient(LoanRecord loan) {
        if (loan == null) {
            return null;
        }
