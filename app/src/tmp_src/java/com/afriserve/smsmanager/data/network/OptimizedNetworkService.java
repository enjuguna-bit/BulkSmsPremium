...
public class OptimizedNetworkService {
    ...
    private OkHttpClient createOkHttpClient(Context context) {
        ...
        return new OkHttpClient.Builder()
            ...
            .addNetworkInterceptor(loggingInterceptor) // Log network calls
     ...
     */
    public retrofit2.Call<PaginatedResponse<SmsNetworkEntity>> getMessagesPaginated(
        int page, 
        int pageSize, 
     ...
     */
    public retrofit2.Call<SmsNetworkEntity> uploadMessage(SmsNetworkEntity message) {
        SmsApiService service = getSmsApiService();
        return service.uploadMessage(message);
    }
    
    /**
     * Sync messages with ETag support
     */
    public retrofit2.Call<PaginatedResponse<SmsNetworkEntity>> syncMessages(
        String eTag, 
        long ifModifiedSince
    ) {
        SmsApiService service = getSmsApiService();
        return service.syncMessages(eTag, ifModifiedSince);
    }
